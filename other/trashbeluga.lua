...
local Window = Library.CreateLib("hotWare released 1.3", "RJTheme7")

local Tab = Window:NewTab("Rage")


local Section = Tab:NewSection("Rage Scripts For KAT!")

Section:NewButton("Aimbot", "Best Aim For Kat!", function()
...
Section:NewButton("Kat F*cker","allows you to take weapons from enemies.", function()
